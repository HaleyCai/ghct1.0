...
public interface RequestMapper {
     ...
     * @return
     */
    Share getTeamShare(@Param("shareId") BigInteger teamShareId, int status);
     ...
     * @return
     */
    Share getSeminarShare(@Param("shareId") BigInteger seminarShareId,int status);
     ...
     * @return
     */
    int updateTeamShareStatus(@Param("shareId") BigInteger teamShareId,int status);
     ...
     * @return
     */
    int updateSeminarShareStatus(@Param("shareId") BigInteger seminarShareId,int status);
